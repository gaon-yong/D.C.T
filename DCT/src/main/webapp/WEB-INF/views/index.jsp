					...
					<div id="myCarousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner" role="listbox">
							<div class="item active">
								<img src="./img/organic.jpg" alt="slide1">
							</div>
							<div class="item">
								<img src="./img/spain.jpg" alt="slide2">
							</div>
							<div class="item">
								<img src="./img/coding.jpg" alt="slide3">
							</div>
						</div>
					...
					<c:forEach var="vo" begin="0" items="${lectureList}" end="4">
						<li>
							<a href="<c:url value='/lecture/lectureDetail?lectureNo=${vo.lectureNo}&pageNum=1&keyword=${pc.paging.keyword }&condition=${pc.paging.condition }' />">
								...
								<span style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: 180px;" >${vo.lectureTitle}</span>
								<span style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: 180px;">강사: ${vo.lectureWriter}</span> 
								<span style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: 180px;">가격: ￦<fmt:formatNumber value="${vo.lecturePrice}" pattern="#,###" />원</span>
							</a>
						</li> 
					</c:forEach>
				</ul>
