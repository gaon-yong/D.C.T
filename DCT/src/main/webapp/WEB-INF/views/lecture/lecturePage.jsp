		...
		<div class="lecture">
			...
			<form action="<c:url value='/lecture/lecturePage' />">
				<div class="lec-search-wrap clearfix">
					...
					<input type="text" class="form-control search2-input" placeholder="강의명을 입력해주세요..." name="keyword" style="margin-right: 2px;">
					<select class="form-control search2-select" name="condition" style="width: 10%; float: right; margin-right: 2px;">
									...
									<input type="checkbox" class="lec-check"> 
										<a href="<c:url value='/lecture/lectureDetail?lectureNo=${vo.lectureNo}&pageNum=${pc.paging.pageNum }&keyword=${pc.paging.keyword }&condition=${pc.paging.condition }' />">
											<div class="lec-list-inner">
												<img src="<c:url value='/lecture/lectureDisplay?thumbnailFileLoca=${vo.thumbnailFileLoca}&thumbnailFilename=${vo.thumbnailFilename}' />" style="max-width: 210px; max-height: 160px; min-width: 210px; min-height: 160px;">
												<div class="lec-content clearfix">
													<div class="lec-info">
														<span style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: 210px;">${vo.lectureTitle}</span>
														<span style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: 210px;">${vo.lectureWriter}</span>
														<br>
														<span class="time"><fmt:formatDate value="${vo.lectureCreateDate }" pattern="yy-MM-dd HH:mm"/></span>
														 
														
													</div>
													<div class="lec-price">
														<strong><fmt:formatNumber value="${vo.lecturePrice }" pattern="#,###" />원</strong>
													</div>
												</div>
											</div>
										</a>
